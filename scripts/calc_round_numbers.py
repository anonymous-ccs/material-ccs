...
def calc_final_numbers_fixed(security_margin):
    ...
    ret_list = []
    (R_F, R_P) = find_FD_round_numbers(N_fixed, t_fixed, cost_function, security_margin)
    min_sbox_cost = cost_function(R_F, R_P, N_fixed, t_fixed)
    ret_list.append(R_F)
    ret_list.append(R_P)
...
print sat_inequiv_cubic(258, 86, 9, 200)
exit()
